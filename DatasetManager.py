...
class DatasetManager:
    def __init__(self, dataset_name, input_file=None, data=None):
        self.dataset_name = dataset_name

        self.dataset_confs = DatasetConfs(dataset_name)

        self.case_id_col = self.dataset_confs.case_id_col[self.dataset_name]
        self.activity_col = self.dataset_confs.activity_col[self.dataset_name]
        self.timestamp_col = self.dataset_confs.timestamp_col[self.dataset_name]
        self.label_col = self.dataset_confs.label_col[self.dataset_name]
        self.pos_label = self.dataset_confs.pos_label[self.dataset_name]

        self.dynamic_cat_cols = self.dataset_confs.dynamic_cat_cols[self.dataset_name]
        self.static_cat_cols = self.dataset_confs.static_cat_cols[self.dataset_name]
        self.dynamic_num_cols = self.dataset_confs.dynamic_num_cols[self.dataset_name]
        self.static_num_cols = self.dataset_confs.static_num_cols[self.dataset_name]
    ...
    if input_file:
        def read_dataset(self):
            ...
            data = pd.read_csv(self.dataset_confs.filename[self.dataset_name], sep=",", dtype=dtypes)
